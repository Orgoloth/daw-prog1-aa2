...
public class CityPrinterByMinimumSumOfExtension implements Controller {
    private CityByGardenExtensionFinder cityByGardenExtensionFinder;
    private CityPrinter printer;
    ...
    private int askMinimumSumGardenExtensionOnCity() {
        int rawMinimumSumGardenExtensionOnCity = Asker
                .number("Introduzca la suma de extensiones mínima dentro de la ciudad:\t");
        return rawMinimumSumGardenExtensionOnCity;
    }
